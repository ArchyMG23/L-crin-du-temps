...
export const DEFAULT_CATEGORIES: Category[] = [
  {
    ...
    name: 'Chronographes',
    slug: 'chronographes',
    description: 'Complications de précision sportive, tachymètres et compteurs de temps haute fréquence.',
  ...
  },
  {
    ...
    slug: 'montres-automatiques',
    description: 'Mouvements mécaniques à remontage perpétuel et réserve de marche prolongée.',
  ...
  },
  {
    ...
    description: 'Robustesse aquatique, lunettes tournantes en céramique et étanchéité absolue.',
  ...
  },
  {
    ...
    description: 'Lignes épurées, boîtiers extra-plats et élégance intemporelle de salon.',
  ...
  },
  {
    ...
    description: 'Mécanismes apparents, ponts ajourés et finitions manuelles d\'exception.',
  ...
  {
    id: 'cat-joaillerie',
    name: 'Pièces Joaillières & Or',
    slug: 'pieces-joaillieres-or',
    description: 'Garde-temps précieux sertis, cadrans en nacre véritable et boîtiers en métaux nobles.',
  ...
  {
    id: 'cat-sport-prestige',
    name: 'Sport Chic & Acier Intégré',
    slug: 'sport-chic-acier-integre',
    description: 'Architecture octogonale ou coussin, bracelets acier brossé intégré et polyvalence.',
  ...
  {
    id: 'cat-vintage-heritage',
    name: 'Vintage & Héritage',
    slug: 'vintage-heritage',
    description: 'Rééditions historiques, cadrans patinés et garde-temps de collection.',
