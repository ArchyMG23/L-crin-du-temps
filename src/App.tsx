  ...
  const handleDuplicateProduct = async (product: Product) => {
    try {
      const cloneData: Omit<Product, 'id' | 'createdAt' | 'updatedAt'> = {
        ...
        collectionId: product.collectionId || product.categoryId,
        collectionName: product.collectionName || '',
        categoryId: product.categoryId,
        gender: product.gender,
        price: product.price,
        promoPrice: product.promoPrice ?? product.promotionalPrice ?? null,
        promotionalPrice: product.promotionalPrice ?? product.promoPrice ?? null,
        currency: product.currency || settings.currency || 'FCFA',
        stock: product.stock,
        ...
        coverImage: product.images[0] || product.coverImage || '',
