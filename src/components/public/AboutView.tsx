...
export const AboutView: React.FC<AboutViewProps> = ({ settings, onNavigate }) => {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 text-[#F5F5F0]">
      ...
      {/* ========================================================================= */}
      <section className="relative rounded-3xl overflow-hidden border border-white/10 bg-[#0A0A0A] p-8 sm:p-14 lg:p-20 shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-r from-black via-black/85 to-[#0A0A0A]/40 z-0 pointer-events-none" />
        ...
        <div className="relative z-10 max-w-3xl space-y-6 text-left">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37]/40 text-[#D4AF37] text-[10px] font-bold tracking-[0.25em] uppercase font-serif">
          ...
          <p className="text-sm sm:text-base text-white/70 leading-relaxed font-sans font-light">
            Fondée avec la volonté d'offrir une expérience horlogère prestigieuse, accessible et personnalisée, <strong className="text-white font-medium">{storeTitle}</strong> sélectionne des garde-temps rares et remarquables pour les passionnés et collectionneurs exigeants.
          </p>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="space-y-4 text-xs sm:text-sm text-white/60 font-sans leading-relaxed">
            <p>
            ...
            <p>
              Chez <strong className="text-white">{storeTitle}</strong>, nous mettons un point d'honneur à allier la rigueur technique de l'expertise horlogère à la proximité d'un service de conciergerie privée. Chaque client bénéficie d'un accompagnement personnalisé tout au long de sa démarche.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-[#111111] border border-white/10 space-y-1">
              <span className="font-serif text-2xl sm:text-3xl font-bold text-[#D4AF37]">100%</span>
              <p className="text-xs text-white/70 font-medium">Contrôle d'authenticité certifié</p>
            </div>
            <div className="p-4 rounded-2xl bg-[#111111] border border-white/10 space-y-1">
              <span className="font-serif text-2xl sm:text-3xl font-bold text-[#D4AF37]">24h</span>
              <p className="text-xs text-white/70 font-medium">Réactivité conciergerie WhatsApp</p>
            </div>
          </div>
        </div>

        <div className="lg:col-span-6 relative">
          <div className="aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 bg-[#121212] shadow-2xl relative">
            <img
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-black/80 backdrop-blur-md p-4 rounded-2xl border border-white/10 flex items-center justify-between">
              <div className="space-y-0.5">
                <span className="text-[10px] uppercase tracking-widest text-[#D4AF37] font-semibold">Atelier & Expertise</span>
                <p className="font-serif text-xs font-bold text-white">Chaque composant vérifié avec précision</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {commitments.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-[#111111] p-6 sm:p-8 rounded-3xl border border-white/10 hover:border-[#D4AF37]/40 transition-all duration-300 flex flex-col justify-between space-y-4 group"
              >
                <div className="space-y-3">
                  <div className="w-12 h-12 rounded-2xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 flex items-center justify-center text-[#D4AF37] group-hover:scale-105 transition-transform">
                ...
                <div className="flex items-center gap-2 text-[11px] text-[#D4AF37] font-semibold tracking-wider uppercase pt-2">
      ...
      {/* ========================================================================= */}
      <section className="bg-[#0E0E0E] border border-white/10 rounded-3xl p-8 sm:p-12 shadow-xl space-y-10">
        <div className="text-center space-y-2 max-w-xl mx-auto">
          <span className="text-[11px] uppercase tracking-[0.25em] text-[#D4AF37] font-serif font-bold">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {standards.map((std, idx) => (
            <div
              key={idx}
              className="bg-[#141414] p-6 rounded-2xl border border-white/5 space-y-3 relative overflow-hidden"
            >
              <span className="font-serif text-3xl font-bold text-white/10 absolute top-4 right-4 select-none">
                {std.step}
              </span>
              <div className="w-8 h-8 rounded-full bg-[#D4AF37]/15 border border-[#D4AF37]/30 text-[#D4AF37] text-xs font-bold flex items-center justify-center font-serif">
                {std.step}
              </div>
      ...
      {/* ========================================================================= */}
      <section className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#161616] via-[#111111] to-[#0A0A0A] border border-white/10 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
          ...
          <Button
            ...
            icon={ArrowRight}
            iconPosition="right"
            className="py-4 px-6 border-white/20 hover:border-[#D4AF37] hover:text-[#D4AF37]"
          >
            Voir la Boutique
          </Button>
        </div>
